...
public class DoubleSlideView extends Group implements AnimationCarrier {

    public DoubleSlideView(double x1, double y1, double x2, double y2, java.time.Duration slidingDuration) {
